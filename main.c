...
static uint8_t OV9655_CONFIG[]=
{
	...
	0x6d,0x55,0x6e,0x00,0x6f,0x9d,0x70,0x21,0x71,0x78,0x72,0x01,
	...
	0xc1,0xc0,0xc2,0x01,0xc3,0x4e,0xc6,0x05,0xc7,0x80,0xc9,0xe0,
...
void OV9655_Snapshot2RAM(void)
{
	...
	// Encode JPEG data
	uint32_t lines = 0;
	while(lines < OV9655_MAXY / 16 -1) // FIXME: Somehow the STM32 only produces 29 interrupts instead of 30
	{
		unsigned x,xb,yb;
		uint16_t color;
...
/**
  ...
  * ISR moves buffer to ov9655_ram_buffer2 so DMA and does not bother JPEG encoding
  * The data is then processed by OV9655_Snapshot2RAM()
  */
void dma_avail(uint32_t flags)
{
	(void)flags;
