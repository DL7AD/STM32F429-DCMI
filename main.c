...
#define OV9655_BUFFER	OV9655_MAXX*16
...
uint16_t ov9655_ram_buffer[OV9655_BUFFER];
uint16_t ov9655_ram_buffer2[OV9655_BUFFER];
...
{
0x00,0x00,0x01,0x80,0x02,0x80,0x03,0x02,0x04,0x03,0x09,0x01, // <= I2C camera for QVGA
...
void dma_avail(uint32_t flags)
{
	...
	memcpy(&ov9655_ram_buffer2, &ov9655_ram_buffer, OV9655_BUFFER*sizeof(uint16_t));
...
void OV9655_InitDMA(void)
{
    ...
    dmaStreamSetTransactionSize(stream, OV9655_BUFFER/sizeof(uint16_t));
