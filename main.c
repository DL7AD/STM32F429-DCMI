...
conv Cb8x8[8][8];		conv Cb8x8[8][8] __attribute__((section(".ram4")));
conv Cr8x8[8][8];		conv Cr8x8[8][8] __attribute__((section(".ram4")));
uint64_t subsclk = 0;
uint64_t readclk = 0;
uint8_t jpeg[30*1024]; // JPEG output buffer
uint32_t jpeg_pos = 0;
